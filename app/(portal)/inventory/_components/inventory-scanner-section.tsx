...
import { useInventoryQuickSearch } from "@/hooks/use-inventory";
import { useDebounce } from "@/hooks/use-debounce";

export function InventoryScannerSection() {
  const {
    pendingUpdates,
    addUpdate,
    isSaving,
  ...
  const { data: searchResults } = useInventoryQuickSearch(debouncedSearch);

  useEffect(() => {
    // Focar no input de código de barras quando o componente montar
